               ...
               <table class="width-100 data alc form-button-row">
                  <tr>
                     <td class="ac">
                        ...
                        <input type="submit" name="Submit" class="btn-green" value="<?=SPINBUTTON?>" />
                        ...
                        <?php }else{ ?>
                        <input type="button" onclick="toURL('<?=$base?>/check.php?isidn=<?=$isidn?>')" class="btn-red" value="<?=SEARCHAGAIN?>" />
                        <?php } ?>
                        <br><br>
                     </td>
                  </tr>
