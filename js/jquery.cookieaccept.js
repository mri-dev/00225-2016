(function ($, document, undefined) {
	...
	$.cookieAccepter = function( url ) {
		...
		text += '<div style="padding-left: 10px; text-align:center; margin-top: 10px;">' +
			...
			'<a id="cookie_accepter_btn" style="background:rgb(227, 31, 36); color:white; padding: 4px; text-decoration:none; box-sizing:border-box; line-height: 22px;" href="javascript:void(0);">Elfogad &gt;</a></div>';

		if( !accept ) {
			$('body').append('<div id="cookie_accepter" style="position:fixed; box-sizing: border-box; z-index: 999999999; bottom:0; background:rgba(33, 138, 191, 0.91); font-size: 14px; color: #ffffff; padding: 1% 20%; width:100%;">'+text+'</div>');
